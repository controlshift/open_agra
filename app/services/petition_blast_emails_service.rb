class PetitionBlastEmailsService < ApplicationService
  klass PetitionBlastEmail
  ...
  def set_initial_moderation_status
    if current_object.recipient_count <= PetitionBlastEmail::RECIPIENT_MODERATION_LIMIT
