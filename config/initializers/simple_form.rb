...
SimpleForm.setup do |config|
  ...
  config.wrappers :compact, :class => 'control-group', :error_class => :error do |b|
    b.use :placeholder
    b.use :tag => 'div', :class => 'controls' do |d|
      d.use :label
      d.use :error, :tag => :span, :class => :'help-inline'
    end
    b.use :input
    b.use :hint, :tag => :span, :class => :'help-block'
  end
  
  config.wrappers :bulk, :class => 'control-group', :error_class => :error do |b|
    b.use :placeholder
    b.use :input
    b.use :hint,  :tag => :span, :class => :'help-block'
  end
